...
- View Profile and browse their Posts, liked posts and liked comments. Also show account age.
- Infinite Scrolling / Pagination
- Sort Posts on basis of attributes such as Most liked, Most comments, Date Created (Oldest or Newest)
...
- Find Others area on homescreen which features random users
...
5) Generate a random JWT secret, Run this script on the terminal:
