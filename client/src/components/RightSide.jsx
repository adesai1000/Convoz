    ...
    return (
        ...
        <div className="hidden md:block w-1/4 p-4">
            <div className="mb-4 border-2 border-slate-600 p-3 rounded flex gap-4">
                ...
                <div className="text-xl text-white font-bold">Don't forget to star the <a href="https://github.com/adesai1000/Convoz" target=" _blank" className="text-[#1976D2] underline font-semibold"> Repo!</a>
                </div>
            </div>
            <div className="mb-4 border-2 border-slate-600 p-3 rounded flex gap-4">
            ...
            <div className="mb-3 border-2 border-slate-600 p-3 rounded ">
                ...
                <div className="flex justify-between">
                    <div className="relative flex rounded-full bg-[#E8E8E8] h-8 w-8 mt-5">
                        ...
                        <p className="ml-4 text-white justify-center text-xl font-bold">ayush</p>
                    </div>
                    <p className="text-[#1976D2] mt-5 justify-center underline cursor-pointer text-xl font-bold" onClick={handProfile}>View</p>
                </div>
                <div className="flex justify-between">
                    <div className="relative flex rounded-full bg-[#E8E8E8] h-8 w-8 mt-5">
                        <img src="https://robohash.org/emma" />
                        <p className="ml-4 text-white justify-center text-xl font-bold">emma</p>
                    </div>
                    <p className="text-[#1976D2] mt-5 justify-center underline cursor-pointer text-xl font-bold" onClick={handProfile}>View</p>
                </div>
                <div className="flex justify-between">
                    <div className="relative flex rounded-full bg-[#E8E8E8] h-8 w-8 mt-5">
                        ...
                        <p className="ml-4 text-white justify-center text-xl font-bold">jack</p>
                    </div>
                    <p className="text-[#1976D2] mt-5 justify-center underline cursor-pointer text-xl font-bold" onClick={handProfile}>View</p>
                </div>
            </div>
