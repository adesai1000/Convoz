        ...
        <>
            <main className="grid min-h-screen place-items-center bg-black px-6 py-24 sm:py-32 lg:px-8 tex-white">
                <div className="text-center">
                    <p className="text-3xl font-semibold text-[#1976D2]">404s and Heartbreaks</p>
                    <h1 className="mt-4 text-2xl font-bold tracking-tight text-white sm:text-5xl">Page not found</h1>
